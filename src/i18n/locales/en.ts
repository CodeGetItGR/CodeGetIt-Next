...
export const en: Translations = {
    ...
    landing: {
        ...
        projects: {
            ...
            title: 'Small proof, honestly shown',
            description: 'The studio is young, so the work is framed as live craft and process rather than a padded portfolio.',
            challengeLabel: 'The honest constraint',
            solutionLabel: 'The approach',
            visitSite: 'Visit the live site',
            live: 'Live',
            artifactEyebrow: 'you get it',
            artifactCaption: 'A modest first build, delivered and owned.',
        },
        testimonials: {
