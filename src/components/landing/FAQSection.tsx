                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full transition-all duration-300 ease-premium ${open ? 'bg-brand-600 text-white rotate-45' : 'bg-slate-100 text-slate-500'}`}>
